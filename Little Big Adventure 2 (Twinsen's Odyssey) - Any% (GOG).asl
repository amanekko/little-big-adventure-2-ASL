    ...
    string[,] settingsTable =
    {
        { null, "Categories", "Categories" },
            { "Categories", "Any_percent", "Any%" },
                { "Any_percent", "sc115", "Emerald Moon" },
                { "Any_percent", "sc94", "Otringal" },
